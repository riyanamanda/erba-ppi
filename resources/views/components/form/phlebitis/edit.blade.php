                    ...
                    <div class="selectgroup w-100">
                        <label class="selectgroup-item">
                            <input type="radio" name="jenis_pemasangan" value="kateter v perifer"
                                ...
                                $surveilans->surveilansable->jenis_pemasangan === "kateter v perifer")>
                        ...
                        <label class="selectgroup-item">
                            <input type="radio" name="jenis_pemasangan" value="umbilikal" class="selectgroup-input"
                                ...
                                $surveilans->surveilansable->jenis_pemasangan === "umbilikal")>
                        ...
                        <label class="selectgroup-item">
                            <input type="radio" name="jenis_pemasangan" value="double lumen" class="selectgroup-input"
                                ...
                                $surveilans->surveilansable->jenis_pemasangan === "double lumen")>
                    ...
                    <div class="selectgroup w-100">
                        <label class="selectgroup-item">
                            <input type="radio" name="tujuan_pemasangan" value="pemberian obat"
                                ...
                                $surveilans->surveilansable->tujuan_pemasangan === "pemberian obat")>
                        ...
                        <label class="selectgroup-item">
                            <input type="radio" name="tujuan_pemasangan" value="transfusi" class="selectgroup-input"
                                ...
                                $surveilans->surveilansable->tujuan_pemasangan === "transfusi")>
                        ...
                        <label class="selectgroup-item">
                            <input type="radio" name="tujuan_pemasangan" value="nutrisi parenteral"
                                ...
                                $surveilans->surveilansable->tujuan_pemasangan === "nutrisi parenteral")>
                        ...
                        <label class="selectgroup-item">
                            <input type="radio" name="tujuan_pemasangan" value="terapi cairan" class="selectgroup-input"
                                ...
                                $surveilans->surveilansable->tujuan_pemasangan === "terapi cairan")>
            ...
            <div class="col-12 col-md-6">
                <div class="form-group">
                    ...
                    <input type="date" class="form-control @error('tanggal_lepas') is-invalid @enderror"
                        ...
                        value="{{ old('tanggal_lepas') ?? $surveilans->surveilansable->tanggal_lepas }}">
                    @error('tanggal_lepas')
                    <strong class="invalid-feedback">
                        {{ $message }}
                    </strong>
        ...
        <div class="row">
            <div class="col-12 col-md-6">
                <div class="form-group">
                    ...
                    <div class="selectgroup w-100">
                        <label class="selectgroup-item">
                            <input type="radio" name="lokasi" value="tangan kanan" class="selectgroup-input" @checked(old('lokasi')==="tangan kanan" || $surveilans->surveilansable->lokasi==="tangan kanan" )>
                            <span class="selectgroup-button">Tangan Kanan</span>
                        </label>
                        <label class="selectgroup-item">
                            <input type="radio" name="lokasi" value="tangan kiri" class="selectgroup-input"
                            @checked(old('lokasi')==="tangan kiri" || $surveilans->surveilansable->lokasi==="tangan kiri" )>
                            <span class="selectgroup-button">Tangan Kiri</span>
                        </label>
                        <label class="selectgroup-item">
                            <input type="radio" name="lokasi" value="kaki kanan" class="selectgroup-input"
                            @checked(old('lokasi')==="kaki kanan" || $surveilans->surveilansable->lokasi==="kaki kanan" )>
                            <span class="selectgroup-button">Kaki Kanan</span>
                        </label>
                        <label class="selectgroup-item">
                            <input type="radio" name="lokasi" value="kaki kiri" class="selectgroup-input"
                            @checked(old('lokasi')==="kaki kiri" || $surveilans->surveilansable->lokasi==="kaki kiri" )>
                    ...
                    <div class="selectgroup w-100">
                        <label class="selectgroup-item">
                            <input type="radio" name="lakukan_pengecekan_tempat_pemasangan" value="1"
                                ...
                                $surveilans->surveilansable->lakukan_pengecekan_tempat_pemasangan == "1")>
                        ...
                        <label class="selectgroup-item">
                            <input type="radio" name="lakukan_pengecekan_tempat_pemasangan" value="0"
                                ...
                                $surveilans->surveilansable->lakukan_pengecekan_tempat_pemasangan == "0")>
                    ...
                    <div class="selectgroup w-100">
                        <label class="selectgroup-item">
                            <input type="radio" name="lakukan_kebersihan_tangan_sebelum_dan_sesudah_pemasangan"
                                ...
                                $surveilans->surveilansable->lakukan_kebersihan_tangan_sebelum_dan_sesudah_pemasangan ==
                            "1")>
                            <span class="selectgroup-button">Ya</span>
                        </label>
                        <label class="selectgroup-item">
                    ...
                    <div class="selectgroup w-100">
                        <label class="selectgroup-item">
                            <input type="radio" name="melepas_pemasangan_apabila_ada_keluhan_atau_peradangan" value="1"
                                ...
                                $surveilans->surveilansable->melepas_pemasangan_apabila_ada_keluhan_atau_peradangan ==
                            "1")>
                            <span class="selectgroup-button">Ya</span>
                        </label>
                        <label class="selectgroup-item">
                    ...
                    <div class="selectgroup w-100">
                        <label class="selectgroup-item">
                            <input type="radio" name="drayssing" value="1" class="selectgroup-input"
                                @checked(old('drayssing')==="1" || $surveilans->surveilansable->drayssing == "1")>
                            <span class="selectgroup-button">Ya</span>
                        </label>
                        <label class="selectgroup-item">
                            <input type="radio" name="drayssing" value="0" class="selectgroup-input"
                                @checked(old('drayssing')==="0" || $surveilans->surveilansable->drayssing == "0")>
                            <span class="selectgroup-button">Tidak</span>
                        </label>
                    </div>
                    @error('drayssing')
                    ...
                    <div class="selectgroup w-100">
                        <label class="selectgroup-item">
                            <input type="radio" name="melepas_pemasangan_apabila_lebih_dari_72_jam" value="1"
                                ...
                                $surveilans->surveilansable->melepas_pemasangan_apabila_lebih_dari_72_jam == "1")>
                            <span class="selectgroup-button">Ya</span>
                        </label>
                        <label class="selectgroup-item">
                            <input type="radio" name="melepas_pemasangan_apabila_lebih_dari_72_jam" value="0"
                                ...
                                $surveilans->surveilansable->melepas_pemasangan_apabila_lebih_dari_72_jam == "0")>
                            <span class="selectgroup-button">Tidak</span>
                        </label>
                    </div>
