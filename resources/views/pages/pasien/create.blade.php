...
@section('content')
<x-layouts.content heading="Tambah Data Pasien">
    <x-slot name="breadcrumb">
        <x-breadcrumb-item :url="route('pasien.index')">Pasien</x-breadcrumb-item>
        <x-breadcrumb-item>Tambah Pasien</x-breadcrumb-item>
    </x-slot>

    <form class="row" action="{{ route('pasien.store') }}" method="POST">
        @csrf
                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control @error('alamat') is-invalid @enderror" id="alamat" name="alamat"
                            style="height: 70px;">{{ old('alamat') }}</textarea>
                        @error('alamat')
                        <strong class="invalid-feedback">
                            {{ $message }}
                        </strong>
